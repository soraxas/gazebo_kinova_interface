...
class KinovaInterface:
    def __init__(self, arm_type: str="j2n6s300", n_dim: int=6, wait: bool=True):
        super().__init__()
        self.n_dim = n_dim
    ...
    def get_current_state(self) -> Tuple[List[float], List[float]]:
        ...
        """
        return self.cached_msg.position, self.cached_msg.velocity
